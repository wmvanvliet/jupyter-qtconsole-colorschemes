...
setup(
    ...
    download_url="https://bitbucket.org/joon/color-schemes-for-ipython-qt-console/get/v0.6.1.zip",
    ...
    entry_points={"pygments.styles": [
        ...
        'material_light = jupyter_qtconsole_colorschemes.material_light:MaterialLightStyle',
